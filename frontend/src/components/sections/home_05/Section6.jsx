...
const dummyReviews = [
  {
    ...
    text: "Crown Network has redefined how I approach energy-backed assets. The platform is reliable, transparent, and future-focused.",
...
countryFlag: "https://imgs.search.brave.com/xusJ7dKYIutUylPh-31Vy1GQ0pP_372wH3tgDFOLpeQ/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/YnJpdGFubmljYS5j/b20vMzMvNDgzMy0w/NTAtRjZFNDE1RkUv/RmxhZy1Vbml0ZWQt/U3RhdGVzLW9mLUFt/ZXJpY2EuanBn"   },
  {
    ...
    text: "Outstanding service and expert financial guidance. Crown Network is a trusted partner for all our investment needs!",
  ...
  },
  {
    ...
    text: "Crown Network delivers exceptional financial services with professionalism and reliability. Highly recommended for anyone seeking trustworthy banking solutions!",
  ...
  //   text: "I've been with Crown Network for several months now, and I can confidently say this is one of the most forward-thinking and impactful companies I’ve ever worked with.",
