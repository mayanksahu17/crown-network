...
export default function PlatinumCard() {
  return (
    <div className="mx-auto w-[360px] h-52 bg-gradient-to-r from-gray-300 to-gray-100 rounded-xl p-4 shadow-lg text-gray-800 relative overflow-hidden">
      {/* Exclusive Badge */}
      <div className="absolute -right-8 top-6 bg-purple-700 text-white text-xs font-bold px-10 py-1 transform rotate-45 shadow-md">
        EXCLUSIVE
      </div>
      ...
      {/* Card Pattern */}
      <div className="bg-white bg-opacity-30 p-4 rounded-lg relative">
        ...
        <div className="absolute top-4 left-4">
          ...
          >
            <path d="M16 6V2H8v4H2v16h20V6h-6zm-6-2h4v2h-4V4zm-4 4h16v10H6V8z" />
            <path d="M8 14h4v2H8zm4-4h4v2h-4zm-4 0h2v2H8z" />
          </svg>
        </div>
      ...
      {/* Exclusive Benefits Tag */}
      <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 text-xs font-semibold bg-purple-700 text-white px-2 py-0.5 rounded-full">
