...
import { addPowerLegTransactions } from "../../services/powerlegService";
...
const PowerLegAccountForm = ({ renderFunc }) => {
  ...
  const handleSubmit = async (data) => {
    ...
    setLoading(true);
    try {
      const response = await addPowerLegTransactions(data);
...
export default PowerLegAccountForm;
